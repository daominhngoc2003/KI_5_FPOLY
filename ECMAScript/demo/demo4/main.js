...
import ProjectAdminEditPage from "./src/pages/admin/Project-edit";
...
router.on("/admin/products", () => render(ProjectAdminPage, app));
router.on("/admin/products/add", () => render(ProjectAdminAddPage, app));
router.on("/admin/products/:id/edit", ({ data }) =>
  render(ProjectAdminEditPage(data), app)
);
